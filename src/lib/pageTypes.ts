...
export const PAGE_TYPES: PageTypeDef[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Brain Dump",
        description: "Syncs to your Brain Dump page for this day.",
        columns: 1,
        page: 2,
        fields: [
      ...
      {
        title: "Focus & ADHD",
        description: "Syncs to your ADHD / Focus Toolkit for this day.",
        columns: 2,
        page: 2,
        fields: [
          { key: "focus_word", label: "One-word intention", type: "text" },
          { key: "med_taken", label: "Meds taken", type: "checkbox" },
          { key: "focus_level", label: "Overall focus", type: "rating", max: 5 },
          { key: "big_three", label: "The 3 that matter today", type: "priority-list", max: 3, span: 2 },
          { key: "wins", label: "Wins (however small)", type: "textarea", rows: 3, span: 2 },
        ],
      },
      {
        title: "Therapy & Coping",
        description: "Session notes sync to your Therapy Session Notes for this day.",
        columns: 1,
        page: 2,
        fields: [
          { key: "therapy_topics", label: "Topics to discuss", type: "priority-list", max: 5, span: 2 },
          { key: "therapy_insights", label: "Session insights", type: "textarea", rows: 4, span: 2 },
          { key: "therapy_actions", label: "My next small steps", type: "textarea", rows: 3, span: 2 },
          { key: "coping_used", label: "Coping tools I used today", type: "textarea", rows: 3, span: 2 },
        ],
      },
      {
        title: "Money Today",
  ...
  },
  {
    ...
    shortName: "Fitness",
    description: "One place for fitness: log each session's exercises and how the body felt, then mark the year-at-a-glance grids.",
    icon: "Dumbbell",
    sections: [
      {
        columns: 2,
      ...
      },
      {
        ...
        description: "One row per workout — the date links it to that day on the Complete Tracker.",
        page: 1,
        fields: [
          {
            key: "strength",
            label: "Sessions and exercises",
            type: "measurement-grid",
            span: 2,
            rowCount: 12,
            rowLabel: "#",
            columns: ["Date", "Activity", "Duration", "Intensity", "Sets", "Reps", "Weight / resistance", "Distance / HR", "Notes"],
            columnKinds: ["date", "select", "text", "select", "text", "text", "text", "text", "text"],
            columnOptions: [null, ["Walking", "Running", "Cycling", "Swimming", "Strength", "Mobility", "Stretching", "Yoga", "Pilates", "Dance", "Sports", "Hiking", "HIIT", "Rehabilitation / PT", "Other"], null, ["Light", "Moderate", "Hard"], null, null, null, null, null],
            columnWidths: ["sm", "md", "sm", "sm", "xs", "xs", "sm", "sm", "lg"],
            rowDetails: true,
            growable: true,
      ...
      },
      {
        ...
        fields: [
          ...
          { key: "pain_notes", label: "Pain or movement limits", type: "textarea", rows: 3 },
          { key: "notes", label: "How it felt", type: "textarea", rows: 3 },
        ],
      },
      { title: "Year at a glance — Cardio", fields: [{ key: "cardio", label: "Cardio", type: "daily-month-grid", span: 2 }] },
      { title: "Year at a glance — Weights", fields: [{ key: "weights", label: "Weights", type: "daily-month-grid", span: 2 }] },
      { title: "Year at a glance — Yoga", fields: [{ key: "yoga", label: "Yoga", type: "daily-month-grid", span: 2 }] },
      { title: "Year at a glance — Stretch", fields: [{ key: "stretch", label: "Stretch", type: "daily-month-grid", span: 2 }] },
      { title: "Year at a glance — Rest day", fields: [{ key: "rest_day", label: "Rest day", type: "daily-month-grid", span: 2 }] },
      { title: "Year at a glance — Other", fields: [{ key: "other", label: "Other", type: "daily-month-grid", span: 2 }] },
    ],
    summary: (v) => (v.year ? `Fitness ${v.year}` : (v.date as string) || "Fitness tracker"),
  },
  {
    id: "medications",
    cadence: "list",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Breakfast this week",
        page: 1,
        fields: [
          {
            key: "meals",
            label: "Breakfast — one line per day",
            type: "measurement-grid",
            span: 2,
            rowCount: 7,
            rowLabel: "Day",
      ...
      {
        title: "Lunch this week",
        page: 1,
        fields: [
          {
            key: "meals",
            label: "Lunch — one line per day",
            type: "measurement-grid",
            span: 2,
            rowCount: 7,
            rowLabel: "Day",
      ...
      },
      {
        ...
        description: "Everything needed for this week's breakfasts.",
        page: 2,
        fields: [
          {
            key: "grocery_by_meal",
            ...
            rowLabel: "Day",
            rowLabels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
            columns: ["Breakfast ingredients"],
            columnWidths: ["lg"],
          },
        ],
      },
      {
        title: "Lunch groceries",
        description: "Everything needed for this week's lunches.",
        page: 2,
        fields: [
          {
            key: "grocery_by_meal",
      ...
      },
      {
        ...
        description: "Everything needed for this week's dinners.",
        page: 2,
        fields: [
          {
            key: "grocery_by_meal",
