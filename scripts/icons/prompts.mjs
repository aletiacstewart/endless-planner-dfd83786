...
export const COVER_STYLE_OVERRIDE = {
  ...
  "patriotic-roses": "Soft luminous still-life photography — cream-ivory backdrop with warm creamy glow, single elegant framed vignette showing the subject beside two or three velvety RED garden roses with dewy petals, gentle painterly light, subtle gold shimmer, dreamy shallow-depth soft focus. Absolutely no flags, no stars, no navy backgrounds, no harsh contrast. Roses are always RED.",
  "patriotic-blue-rose": "Soft luminous still-life photography — cream-ivory backdrop with warm creamy glow, single elegant framed vignette showing the subject beside two or three velvety BLUE garden roses with dewy petals, gentle painterly light, subtle gold shimmer, dreamy shallow-depth soft focus. Absolutely no flags, no stars, no navy backgrounds, no red roses. Every rose is BLUE.",
  ...
  "patriotic-white-rose": "Soft luminous still-life photography — cream-ivory backdrop with warm creamy glow, single elegant framed vignette showing the subject beside two or three velvety WHITE garden roses with dewy petals, gentle painterly light, subtle gold shimmer, dreamy shallow-depth soft focus. Absolutely no flags, no stars, no navy backgrounds, no red or blue roses. Every rose is WHITE.",
