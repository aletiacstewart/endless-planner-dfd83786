...
export const PAGE_SUBJECTS = {
  ...
  "daily-journal": "an open blank journal with a feather pen, a small instant-photo frame, and a delicate pencil arranged as a creative memory emblem — no writing",
  ...
  "sleep-tracker": "a slim crescent moon cradling three tiny drifting stars above a softly folded pillow, symbolic restful-night emblem",
  "water-tracker": "a tall slender glass tumbler half-filled with clear water, one droplet suspended above it and a gentle ripple ring below",
  "gratitude-log": "two cupped open hands holding a small radiant heart with soft light rays, symbolic thankfulness emblem",
