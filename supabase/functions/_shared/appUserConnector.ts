...
/** A gateway 401 whose body type starts with "credential_" means this user's connection must be re-authorized. */
...
/** Swap the one-time code from the redirect landing page for the per-user connection key (lovack_*). Server-only. */
